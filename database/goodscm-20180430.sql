...
CREATE TABLE IF NOT EXISTS `goods` (
  ...
  `net_weight` smallint(6) DEFAULT NULL COMMENT '净重',
  `weight_after_packing` smallint(6) DEFAULT NULL COMMENT '包装后重量',
  `length` smallint(6) DEFAULT NULL COMMENT '包装前体积(Cm) - 长',
  `width` smallint(6) DEFAULT NULL COMMENT '包装前体积(Cm) - 宽',
  `height` smallint(6) DEFAULT NULL COMMENT '包装前体积(Cm) - 高',
  `packing_length` smallint(6) DEFAULT NULL COMMENT '包装后体积(Cm) - 长',
  `packing_width` smallint(6) DEFAULT NULL COMMENT '包装后体积(Cm) - 宽',
  `packing_height` smallint(6) DEFAULT NULL COMMENT '包装后体积(Cm) - 高',
  `latest_purchase_price` smallint(6) DEFAULT NULL COMMENT '最新采购价',
