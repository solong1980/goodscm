...
-- 正在导出表  goodscm.goods 的数据：~16 rows (大约)
...
INSERT INTO `goods` (`id`, `code`, `short_name`, `category_id`, `vendor_goods_code`, `name_zh`, `name_en`, `net_weight`, `weight_after_packing`, `length`, `width`, `height`, `packing_length`, `packing_width`, `packing_height`, `purchase_price`, `retail_price`, `trade_price`, `stock`, `stock_unit`, `memo`, `zh_info`, `en_info`, `ext_info`, `status`, `create_time`, `update_time`) VALUES
	...
	(4, '1111', 'company short name', 1000, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 10, NULL, NULL),
	(5, '1111', 'company short name', 1000, NULL, '强强强', 'strongstring', 10.00000, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 10, NULL, NULL),
	(6, '1111', 'company short name', 1000, NULL, '强强强', 'strongstring', 10.00000, 10.00000, 10.00, 10.00, 10.00, 10.00, 10.00, 10.00, 10.00, 10.00, 10.00, 10.00, 1, NULL, NULL, NULL, NULL, 10, NULL, NULL),
	(7, '1111', 'company short name', 1000, NULL, '强强强', 'strongstring', 10.00000, 10.00000, 10.00, 10.00, 10.00, 10.00, 10.00, 10.00, 10.00, 10.00, 10.00, 10.00, 1, 'Meno', 'zh_info', 'en_info', 'ext_info', 10, NULL, NULL),
	(8, '1111', 'company short name', 1000, NULL, '强强强', 'strongstring', 10.00000, 10.00000, 10.00, 10.00, 10.00, 10.00, 10.00, 10.00, 10.00, 10.00, 10.00, 10.00, 1, 'Meno', 'zh_info', 'en_info', 'ext_info', 10, '2018-05-02 20:32:31', NULL),
	(9, '1111', 'company short name', 1000, NULL, '强强强', 'strongstring', 10.00000, 10.00000, 10.00, 10.00, 10.00, 10.00, 10.00, 10.00, 10.00, 10.00, 10.00, 10.00, 1, 'Meno', 'zh_info', 'en_info', 'ext_info', 10, '2018-05-02 20:33:04', '2018-05-02 20:33:03'),
	(10, '1111', 'company short name', 1000, NULL, '强强强', 'strongstring', 10.00000, 10.00000, 10.00, 10.00, 10.00, 10.00, 10.00, 10.00, 10.00, 10.00, 10.00, 10.00, 1, 'Meno', 'zh_info', 'en_info', 'ext_info', 10, '2018-05-02 20:36:27', '2018-05-02 20:36:27'),
	(11, '1111', 'company short name', 1000, NULL, '强强强', 'strongstring', 10.00000, 10.00000, 10.00, 10.00, 10.00, 10.00, 10.00, 10.00, 10.00, 10.00, 10.00, 10.00, 1, 'Meno', 'zh_info', 'en_info', 'ext_info', 10, '2018-05-02 20:40:56', '2018-05-02 20:40:56'),
	(12, '1111', 'company short name', 1000, NULL, '强强强', 'strongstring', 10.00000, 10.00000, 10.00, 10.00, 10.00, 10.00, 10.00, 10.00, 10.00, 10.00, 10.00, 10.00, 1, 'Meno', 'zh_info', 'en_info', 'ext_info', 10, '2018-05-02 20:41:47', '2018-05-02 20:41:47'),
...
CREATE TABLE IF NOT EXISTS `goods_pic` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=31 DEFAULT CHARSET=utf8 COMMENT='商品图片表';

-- 正在导出表  goodscm.goods_pic 的数据：~30 rows (大约)
